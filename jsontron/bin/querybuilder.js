...
const schInstance = require('../data/dissertation/context/bookdata_dataForContext_good1.json');
// const schInstance = require('../data/dissertation/context/loandata_dataForContext_good1.json');
// var authors = jp.query(schInstance, '$.store.book');

// const schInstance = require("./data/dissertation/loandata-main/loandata-main-bad1.json");
// var loans = jp.query(schInstance, "$..loan_data.loans[?(@.origination_id == 'branch')]");


const contextNode = jp.query(schInstance, '$..loans.*'); // select all book items in the document
...
const test = jp.query(contextNode, '$..[?(@.loan_type == \'FHA\')]');
