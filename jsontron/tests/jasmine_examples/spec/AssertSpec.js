describe("Assert tests with good data", function() {
  var jsontron = require('../../../lib/jsontron.js');
  var schInstance = require('../../../data/dissertation/assert/loandata_dataForAssert_good1.json');
  var schRules_doc = require('../../../data/dissertation/assert/loandata-rules_dissertation_assert_good1.json');
  //var myReport;
  //var valid;
...
describe("Pattern Tests with bad data", function() {
	  ...
	  var schInstance_dataForAssert_bad1 = require('../../../data/dissertation/assert/loandata_dataForAssert_bad1.json');
	  var schRules_doc = require('../../../data/dissertation/assert/loandata-rules_dissertation_assert_good1.json');
	  //var myReport;
	  //var valid;
	  ...
	  it("should only process patterns in single named phase1", function() {
	    ...
	    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['precheck']).errors.length).toEqual(0);
	  ...
	  it("should only process patterns in another single named phase2", function() {
			...
			//console.log("testing phase 2 :" + jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['phaseid2']).valid );
		    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['phaseid1']).valid).not.toBe(true);
	  ...
	  it("should process multiple patterns from  multiple named phases", function() {
		    ...
		    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['phaseid1', 'phaseid2']).valid).not.toBe(true);
	  ...
	  it("should process all patterns in all phases with keyword #ALL", function() {
		    ...
		    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['#ALL']).valid).not.toBe(true);
	  ...
	  it("should process patterns in default phase with keyword #DEFAULT", function() {
		    ...
		    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['#DEFAULT']).valid).not.toBe(true);
	  ...
	  it("should process all patterns in all phases as no phases are mentioned", function() {
		    ...
		    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc).valid).not.toBe(true);
	  ...
	  it("should process all patterns in all phases as invalid phase name is mentioned", function() {
		  	...
		  	console.log("Test: All patterns in all phases when wrong phase is mentioned...");
		    expect(jsontron.JSONTRON.validate(schInstance_dataForAssert_bad1, schRules_doc, ['blah']).valid).not.toBe(true);
